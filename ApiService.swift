...
class ApiService{
    ...
    static var sharedObg = ApiService()
...
"""
    ...
    func vrat (){
        ...
        do{
            let task =  try? JSONDecoder().decode( Welcome.self,from: jsonObjectData!)
            print(task)
        }catch{
        ...
        //
        //    let jsonObjectData = jsonObject.data(using: .utf8)
        //    let welkom = try? JSONDecoder().decode( Welcome.self,from: jsonObjectData!)
        //
        //        print(welkom?.todos ?? 00)
        //
        //    }
        //
        //
